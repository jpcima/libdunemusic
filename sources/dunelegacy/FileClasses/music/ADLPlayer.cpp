...
ADLPlayer::ADLPlayer() : MusicPlayer(true/*settings.audio.playMusic*/, 64/*settings.audio.musicVolume*/) {
...
void ADLPlayer::changeMusic(MUSICTYPE musicType)
{
    ...
    */
    ...
    changeMusicEx(musicType, filename, musicNum);
}

void ADLPlayer::changeMusicEx(MUSICTYPE musicType, const std::string &filename, int musicNum)
{
